...
class Object_Schema extends Base_Schema {
  constructor(type, fields, required_fields) {
  ...
  clone(type) {
    return new Object_Schema(type, this.fields, this.required_fields)
  }
...
class Array_Schema extends Array_Like_Schema {
  ...
  clone(type) {
    return new Array_Schema(type, this.min_length, this.max_length, this.child_schema)
  }
...
class String_Schema extends Array_Like_Schema {
  ...
  clone(type) {
    return new String_Schema(type, this.min_length, this.max_length, this.regex)
  }
...
class Enum_Schema extends String_Schema {
  ...
  clone(type) {
    return new Enum_Schema(type, Array.from(this.enums))
  }
...
class Integer_Schema extends String_Schema {
  ...
  clone(type) {
    return new Integer_Schema(type, this.min, this.max)
  }
...
class BigInt_Schema extends String_Schema {
  ...
  clone(type) {
    return new BigInt_Schema(type, this.min, this.max)
  }
...
class Decimal_Schema extends String_Schema {
  ...
  clone(type) {
    return new Decimal_Schema(type, this.min.string, this.max.string)
  }
