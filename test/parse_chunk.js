  ...
  describe('split the payload at every character', () => {
    describe('valid', () => {
      const tests = [
        ...
        [["string 0 10", "0 10"], '[]', [], 'arr empty'],
        [["string 0 10", "0 10"], '["0","123","45"]', ['0','123','45'], 'arr string'],
        [["int_4 0 200", "0 10"], '["0","123","45"]', [0,123,45], 'arr int'],
        [["?", "int_4 0 200", "0 10"], '["0","123","45"]', [0,123,45], '?arr'],
        [["?", "int_4 0 200", "0 10"], 'null', null, '?arr null'],
        [[["int_4 0 200", "0 10"], "0 10"], '[["0","123"],["2"]]', [[0,123],[2]], 'arr[]'],
        [[{"- olo":"string 0 1"}, "0 10"], '[{},{"olo":"a"}]', [{},{olo:'a'}], 'arr obj'],
    ...
    describe('invalid', () => {
      const tests = [
        ...
        [["string 0 10", "0 10"], '"a"]', 'Invalid array opening char. Expected: [, found: "', 'arr invalid start'],
        [["string 0 10", "0 10"], '["a",]', 'Invalid string opening char. Expected: ", found: ]', 'arr string start'],
        [["string 0 10", "0 10"], '["a""b"]', 'Invalid array enclosing char. Expected: , or ], found: "', 'arr end or comma'],
        [["string 0 10", "0 10"], '["a","b"', 'Incomplete payload. Some characters are missing at the end', 'arr enclosing'],
